...
设$E$是一平面点集，$\MC$中的点对$E$而言可以分为三类：(1)如果存在$r>0$，使得$B(a,r)\subset E$，就称$a$为$E$的\textbf{内点}\index{J!集!内点}；(2)如果存在$r>0$，使得$B(a,r)\subset E^{\textrm c}$，就称$a$为$E$的\textbf{外点}\index{J!集!外点}，这里，$E^{\textrm c}$是由所有不属于$E$的点构成的集，称为$E$的\textbf{余集}\index{J!集!余集}或\textbf{补集}\index{J!集!补集}；(3)如果对任意$r>
...
|u(x, y)-\alpha| & \leqslant|f(z)-a| \\
& \leqslant|u(x, y)-\alpha|+|v(x, y)-\beta|, \\
|v(x, y)-\beta| & \leqslant|f(z)-a| \\
& \leqslant|u(x, y)-\alpha|+|v(x, y)-\beta|
